...
export default function BatchPage() {
  ...
  return (
    <>
      <HeaderTitle title="Creator Studio — Batch" />

      <div className="space-y-1">
        <h2 className="text-xl font-semibold">Creator Studio (Batch)</h2>
        <p className="text-sm text-muted-foreground">Dépose plusieurs images, choisis tes options, lance jusqu'à {CONCURRENCY} traitements en parallèle.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="rounded-2xl">
          <CardHeader>
            ...
            <CardDescription>Dépose plusieurs images (JPG, PNG, WEBP, max 15 Mo chacune). Tu peux en retirer.</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      {jobs.length > 0 && (
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {jobs.map((j) => (
              <div key={j.id} className="rounded-lg border p-3 flex items-center gap-3">
